public class Story{
   ...
   public static void town_main(String name_town,Pokemon[] pokemons){
	...
	while(true){
	   ...
	   switch(ch){ 
		 ...
		 break;
	   	 ...
	   	 break;
	   	 case 6  : new Save().save(pokemons); new Save().save_badge(View.badge);  break;
	   	 case 7  : 
   ...
   {   int ch = Fuction.getChoice(9);
	   ...
	   //bgm.close();
	   f.Fight(mypok[0], Pok_arr.pok_arr[View.mytown][ch-1]);}
   	   else {
